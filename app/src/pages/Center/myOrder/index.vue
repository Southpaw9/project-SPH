<template>
          ...
          <div class="order-content">
            ...
            <div class="orders">
              ...
              <table class="order-item" v-for="orderInfo in orderList.records" :key="orderInfo.id">
                <thead>
                  <tr>
                    <th colspan="5">
                      <span class="ordertitle">{{orderInfo.createTime}}　订单编号：{{orderInfo.outTradeNo}} <span
                          class="pull-right delete"><img src="../images/delete.png"></span></span>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(orderDetail,index) in orderInfo.orderDetailList" :key="index">
                    <td width="60%">
                      <div class="typographic">
                        <img :src="orderDetail.imgUrl" style="width:50px;height:50px">
                        <a href="#" class="block-text">{{orderDetail.skuName}}</a>
                        <span>X{{orderDetail.skuNum}}</span>
                        <a href="#" class="service">售后申请</a>
                      </div>
                    </td>     
                    <td :rowspan="orderInfo.orderDetailList.length"  v-if="index==0" width="8%" class="center">小丽</td>
...
<Pagination :pageNo="page" :pageSize="limit" :total="orderList.total" continues="5" @get-pageno="getPageNo"/>
            </div>
          </div>
          <!--猜你喜欢-->
          <div class="like">
